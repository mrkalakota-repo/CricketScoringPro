...
- **Do not** downgrade `react-native-purchases` below v10 — v9.x throws an NSException in `configure()` on iOS 26 that crashes Hermes in the TurboModule bridge and kills the app on launch.
